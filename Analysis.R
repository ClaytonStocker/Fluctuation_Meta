...
pacman::p_load(tidyverse, readxl, gtsummary, dplyr, 
               ...
               robumeta, ggpmisc, ggridges, ggbeeswarm, gridExtra, clubSandwich)
...
Amplitude_Plot <- ggplot(Plot_Data, aes(x = T2_Magnitude, y = InRR_Transformed)) + 
                  ...
                  labs(x = "Fluctuation Amplitude (\u00B0C)", y = "Effect Size (lnRR)", 
...
Population_Amplitude_Model_rob <- robust(Population_Amplitude_Model, cluster = Population_Subset_Data$Study_ID, adjust = TRUE)
...
Raw_Aquatic_Specific_Trait <- data.frame("Specific Phenotypic Traits" = c("Apparent Digestibility Coefficient", "Cortisol Levels", "Development Time", 
...
Raw_Acclimation_Specific_Trait <- data.frame("Specific Phenotypic Traits" = c("Apparent Digestibility Coefficient", "Catalase Activity", "Cortisol Levels", "Food Consumption", 
...
Heterogeneity_Population <- data.frame("Models" = c("Population-level Traits", "Fluctuation Amplitude", 
                                       ...
                                       "Shared Animal" = c(Population_Model_i2[6, 1], Population_Amplitude_Model_i2[6, 1], 
                                                           Population_Fluctuation_Model_i2[6, 1], Population_Class_Model_i2[6, 1]), 
                                       "Measurement" = c(Population_Model_i2[7, 1], Population_Amplitude_Model_i2[7, 1], 
                                       ...
                                       "Species" = c(Population_Model_i2[5, 1], Population_Amplitude_Model_i2[5, 1], 
...
Heterogeneity_Acclimation <- data.frame("Models" = c("Acclimation", "Exposure Time", "Fluctuation Amplitude", "Fluctuation Type", "Life-history Stage", 
                                        ...
                                        "Measurment" = c(Acclimation_Model_i2[7, 1], Acclimation_Exposure_Model_i2[7, 1], Acclimation_Amplitude_Model_i2[7, 1], Acclimation_Fluctuation_Model_i2[7, 1], Acclimation_Stage_Model_i2[7, 1], 
